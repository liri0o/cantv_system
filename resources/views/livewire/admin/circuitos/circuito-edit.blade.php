    ...
    <form wire:submit="store">
        ...
        <div class="card bg-gray-300 mb-6">
            ...
            <div class="mb-4">
                ...
                <x-input wire:model="circuitoEdit.circuito_num" class="w-full"
                    placeholder="Ingrese el número del circuito" />
            </div>
            ...
            <div class="mb-4">
                ...
                <x-input wire:model="circuitoEdit.iplan_bloq" class="w-full"
                    placeholder="Ingrese el numero de circuito" />
            </div>
            ...
            <div class="mb-4">
                ...
                <x-input wire:model="circuitoEdit.ip_loopback" class="w-full"
                    placeholder="Ingrese el numero de circuito" />
            </div>
            ...
            <div class="mb-4">
                ...
                <x-input wire:model="circuitoEdit.short_description" class="w-full"
                    placeholder="Ingrese una descripción corta del circuito" />
            </div>            
        </div>
