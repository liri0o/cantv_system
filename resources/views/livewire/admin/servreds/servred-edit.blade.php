    ...
    <form wire:submit="store">
        ...
        <div class="card">
            ...
            <div class="mb-4">
                ...
                <x-input wire:model="servredEdit.equip_marca" class="w-full" placeholder="Ingrese la marca del equipo" />
            </div>
            <div class="mb-4">
                <x-label class="mb-1">
                    Modelo del equipo
                </x-label>
                <x-input wire:model="servredEdit.equip_modelo" class="w-full" placeholder="Ingrese el modelo del equipo" />
            </div>
            <div class="mb-4">
                <x-label class="mb-1">
                    Serial del equipo
                </x-label>
                <x-input wire:model="servredEdit.equip_serial" class="w-full" placeholder="Ingrese el serial del equipo" />
            </div>
            <div class="mb-4">
                <x-label class="mb-1">
